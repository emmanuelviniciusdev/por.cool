<template>
  <div>
    ...
    <p>O Porcool respeita o direito à privacidade e zela pela segurança dos dados de seus usuários.</p>
    ...
    <h2 class="subtitle has-text-weight-bold">Segurança</h2>
    <p>O Porcool se utiliza de medidas de segurança comercialmente razoáveis para proteger as informações contidas em nosso banco de dados. Contudo, sabe-se que nenhum sistema de segurança é 100% seguro. Sendo assim, por mais que façamos o possível para proteger suas informações pessoais, não temos como garantir a absoluta segurança em nossa plataforma. É possível que os dados que você forneça em nossos sistemas possam ser interceptados por terceiros durante a transmissão. Portanto, é uma decisão sua a utilização de nossos serviços nestas condições.</p>
    <p>Sua senha é secreta, então a mantenha em segurança e não a divulgue para ninguém.</p>
    <p>Não solicitaremos, em hipótese alguma, sua senha ou qualquer outra informação pessoal por e-mail, telefone ou por qualquer outro lugar senão o Porcool.</p>
    <p>Caso compartilhe o seu dispositivo com alguém ou vai utilizar o Porcool através de um dispositivo público, recomendamos que sempre se desconecte da sua conta e feche a janela do seu navegador assim que terminar de utilizar o Porcool. É uma boa prática e uma boa medida de segurança.</p>
  </div>
</template>
