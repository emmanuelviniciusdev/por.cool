  ...
  <div>
    <div class="columns is-multiline">
        <div class="column">
            ...
            <p>Bom, por enquanto, o porcool é uma ferramenta muito simples e, enquanto estiver em sua versão beta, você conseguirá gerenciar os seus gastos do dia a dia e a sua renda mensal. <i>Tudo o que uma simples planilha faria, só que melhor.</i></p>
            <p class="is-italic has-text-weight-bold">Tudo na nuvem</p>
            <p>Como o porcool é um aplicativo <i>web</i>, todos os seus dados ficarão disponíveis na nuvem e acessíveis de qualquer dispositivo que possua acessso à internet.</p>
            <br>
